        ...
        <div class="row">
            ...
            <?php
                ...
                <!--<a href=<?='"'.Yii::getAlias('@web').'/ged?id='.$data['id'].'& nombre='.$data['nombre'].'"'?>><img src=<?='"'.Yii::getAlias('@web').'/img/logos/escuelas/logo'.$data['id'].'.png'.'"'?> class="card-img-top" alt="voleibol"></a>-->
                    <a href=<?='"'.Yii::getAlias('@web').'/index.php?r=atletas/atletas-registro/index&id='.$data['id'].'& nombre='.$data['nombre'].'"'?>><img src=<?='"'.Yii::getAlias('@web').'/img/logos/escuelas/logo'.$data['id'].'.png'.'"'?> class="card-img-top" alt="voleibol"></a>
